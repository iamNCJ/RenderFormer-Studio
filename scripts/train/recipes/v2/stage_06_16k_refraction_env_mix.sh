#!/usr/bin/env bash
# V2 release curriculum: 16k-token refraction environment/no-environment mix.
...
RECIPE_KEY=v2/stage_06_16k_refraction_env_mix
FAMILY=v2-200m-sss
STAGE_ORDER=6
STAGE_NAME=stage_06_16k_refraction_env_mix
DEFAULT_RUN_ID=v2_stage_06_16k_refraction_env_mix
PREDECESSOR_RUN_ID=v2_stage_05_16k_env_volume
TRAINING_VERSION=rf2
MODEL_CONFIG=configs/model/v2/200m_sliding_sink_summary.yaml
DATA_CONFIG=configs/data/v2/stage_06_16k_refraction_env_mix.yaml
