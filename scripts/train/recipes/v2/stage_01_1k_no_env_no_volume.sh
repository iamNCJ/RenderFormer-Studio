#!/usr/bin/env bash
# V2 release curriculum: 1k-token stage without environment maps or volumes.
...
RECIPE_KEY=v2/stage_01_1k_no_env_no_volume
FAMILY=v2-200m-sss
STAGE_ORDER=1
STAGE_NAME=stage_01_1k_no_env_no_volume
DEFAULT_RUN_ID=v2_stage_01_1k_no_env_no_volume
PREDECESSOR_RUN_ID=''
TRAINING_VERSION=rf2
MODEL_CONFIG=configs/model/v2/200m_sliding_sink_summary.yaml
DATA_CONFIG=configs/data/v2/stage_01_1k_no_env_no_volume.yaml
