#!/usr/bin/env bash
# V2 release curriculum: 1k-token environment/volume mixture stage.
...
RECIPE_KEY=v2/stage_03_1k_env_volume_mix
FAMILY=v2-200m-sss
STAGE_ORDER=3
STAGE_NAME=stage_03_1k_env_volume_mix
DEFAULT_RUN_ID=v2_stage_03_1k_env_volume_mix
PREDECESSOR_RUN_ID=v2_stage_02_1k_no_env_no_volume_texture_mix
TRAINING_VERSION=rf2
MODEL_CONFIG=configs/model/v2/200m_sliding_sink_summary.yaml
DATA_CONFIG=configs/data/v2/stage_03_1k_env_volume_mix.yaml

DATASET_ARGS=(
  --dataset-config.padding-length 1536
  --dataset-config.volume-padding-length 512
)
